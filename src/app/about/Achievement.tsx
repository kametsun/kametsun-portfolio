...
export const Achievement = (): ReactElement => {
  ...
  return (
        <div className="my-12 w-9/10 bg-background bg-opacity-70 p-4 md:p-10 lg:w-3/5 xl:w-1/2">
            <h1 className="w-fit border-b-2 border-indigo-600 text-2xl">Achievement</h1>
            <table className="my-5 w-full table-auto">
                ...
                {achievements.map((achievement, index) => (
                    <tr key={index} className="hover:text-background border-l border-indigo-600 bg-background">
